...
function App({ update_list }) {
  ...
  return (
    <div className="bg-blue-100 font-sans">
      ...
      <div className="fixed top-0 left-0 w-full bg-blue-600 text-white text-center py-3">
        <h1 className="text-xl">Juspay Assignment</h1>
      </div>

      {/* Main content area */}
      <div className="h-screen pt-20 overflow-hidden flex flex-row">
